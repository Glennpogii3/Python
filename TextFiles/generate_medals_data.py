...
with open(r'C:\xampp\htdocs\Python\TextFiles\OlympicMedals_2020.csv', encoding='utf-8', newline='') as data,\
        open(r'C:\xampp\htdocs\Python\TextFiles\medals_dict.py', 'w', encoding='utf-8') as output_file:
    ...
    for row_dict in reader:
        ...
        # (indented by 4 spaces, with a trailing comma).s
