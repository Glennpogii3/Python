...
colour_print("Hello, Blue in Reverse", BLUE, REVERSE)
colour_print("Hello, Yellow", YELLOW)
colour_print("Hello, Yellow in Underline", YELLOW, UNDERLINE)
...
name = input("Plase enter ur name") 
if name != "":  
    colour_print("Hello, {}".format(name),RED)
else: 
    colour_print ("No name specified")